...
EXPECTED_FIELDS: dict[str, list[tuple[str, ...]]] = {
    ...
    "exp13": [
        ("strategies", "softmax", "f1"),
        ("strategies", "softmax", "accuracy"),
        ("strategies", "softmax", "latency_ms"),
        ("strategies", "sigmoid", "f1"),
        ("strategies", "sigmoid", "accuracy"),
        ("strategies", "sigmoid", "latency_ms"),
