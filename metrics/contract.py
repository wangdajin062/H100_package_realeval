...
EXPECTED_FIELDS: dict[str, list[tuple[str, ...]]] = {
    ...
    "exp3": [
        ...
        # layer_selection keys are projection-layer subsets (paper Fig6a q→v→k→o order).
        ("layer_selection", "q", "f1"),
        ("layer_selection", "q", "variance_drift_pct"),
        ("layer_selection", "q_v", "f1"),
        ("layer_selection", "q_v", "variance_drift_pct"),
        ("layer_selection", "q_v_k", "f1"),
        ("layer_selection", "q_v_k", "variance_drift_pct"),
        ("layer_selection", "q_v_k_o", "f1"),
        ("layer_selection", "q_v_k_o", "variance_drift_pct"),
        # window_sweep sweeps rescale_strength (forward rescaling intensity, Eq.8).
        ("window_sweep", "strength_0.0", "f1"),
        ("window_sweep", "strength_0.0", "ppl"),
        ("window_sweep", "strength_0.2", "f1"),
        ("window_sweep", "strength_0.2", "ppl"),
        ("window_sweep", "strength_0.4", "f1"),
        ("window_sweep", "strength_0.4", "ppl"),
        ("window_sweep", "strength_0.6", "f1"),
        ("window_sweep", "strength_0.6", "ppl"),
        ("window_sweep", "strength_0.8", "f1"),
        ("window_sweep", "strength_0.8", "ppl"),
        ("window_sweep", "strength_1.0", "f1"),
        ("window_sweep", "strength_1.0", "ppl"),
    ],
    "exp4": [
    ...
    "exp9": [
        ("with_cot", "f1"),
        ("with_cot", "fpr"),
        ("with_cot", "advfraud_f1"),
        ("without_cot", "f1"),
        ("without_cot", "fpr"),
        ("without_cot", "advfraud_f1"),
    ],
    "exp10": [
    ...
    "exp12": [
        ("competitor_comparison_real", "QAD_MultiGuard_NVFP4", "f1"),
